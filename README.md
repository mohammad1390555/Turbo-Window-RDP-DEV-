# ⚡ Turbo Window — RDP Toolkit + 🤖 Telegram Bot v4.0

This repository hosts two subprojects:

1. **Windows RDP performance toolkit** — connection optimizers, latency tweaks and admin scripts for smoother remote desktop sessions.
2. **Telegram Bot v4.0** — a feature-rich, modular Telegram bot with VPN config distribution, media downloading, proxy service, file-to-link, VIP subscriptions, and full admin panel.
...
### Features
- 🔧 Connection tuning presets for low-latency RDP
- 📉 Latency diagnosis scripts
- 🖥️ Admin automation for session management
- ⚙️ Group-policy & registry tweaks documented

### Status
🚧 Development repository — scripts land here first, docs follow.

---

## Part 2 — Telegram Bot v4.0 (Modular Architecture)
...
Check out my other projects on my [profile](https://github.com/mohammad1390555).
